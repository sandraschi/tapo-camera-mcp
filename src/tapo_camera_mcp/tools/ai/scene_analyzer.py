...
class SceneAnalyzerTool(BaseTool):
    ...
    async def execute(
        ...
        try:
            ...
            if analysis_type == "comprehensive":
                result = await self._comprehensive_analysis(snapshot_data, include_objects, include_activities, confidence_threshold)
    ...
    async def _scene_type_analysis(self, image_data: bytes, confidence_threshold: float) -> SceneAnalysisResult:
    ...
    async def _detect_objects(self, image_data: bytes, confidence_threshold: float) -> List[Dict[str, Any]]:
