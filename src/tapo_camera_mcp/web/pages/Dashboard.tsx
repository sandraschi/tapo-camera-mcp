...
export const Dashboard: React.FC<DashboardProps> = ({ className }) => {
  ...
  return (
    <div className={`min-h-screen bg-gray-50 dark:bg-slate-950 ${className}`}>
      {/* Header */}
      ...
      <div className="flex">
        {/* Sidebar */}
        <aside className={`
          fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-slate-900 shadow-lg border-r dark:border-slate-800 transform transition-transform duration-300 ease-in-out
              ...
              {navigationItems.map((item) => {
                ...
                return (
                  <Button
                    ...
                    className={`w-full justify-start h-12 ${isActive ? '' : 'hover:bg-gray-100 dark:hover:bg-slate-800'}`}
                    onClick={() => {
