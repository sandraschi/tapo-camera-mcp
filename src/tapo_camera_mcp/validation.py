...
import inspect
import logging
from typing import Any, Dict, List, Optional, Type, Union, Callable, Awaitable, get_type_hints
...
def validate_string_length(value: str, field_name: str, min_length: int = None, max_length: int = None) -> str:
        ...
        try:
            ...
            for param_name, param_value in bound_args.arguments.items():
                ...
                if param_name in ['camera_name', 'name']:
                    ...
                    validate_string_length(param_value, param_name, min_length=1, max_length=100)
                elif param_type and hasattr(param_type, '__origin__') and param_type.__origin__ is list:
            ...
            return ToolResult(
                content={"error": e.message, "field": e.field},
                is_error=True
            )
...
def handle_tool_errors(func: Callable) -> Callable:
    ...
    async def wrapper(*args, **kwargs):
        try:
            ...
            return ToolResult(
                content={"error": e.message, "type": "validation_error"},
                is_error=True
            )
