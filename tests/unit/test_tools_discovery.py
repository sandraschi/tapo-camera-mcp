...
def test_tools_discovery():
    ...
    try:
        ...
        for tool_cls in tools:
            ...
            assert 'Tool' in tool_cls.__name__, f"Tool class name should contain 'Tool'"
...
def test_tool_registry():
    ...
    try:
        from tapo_camera_mcp.tools.base_tool import register_tool, get_all_tools, get_tool
...
def test_base_tool_structure():
    ...
    try:
        ...
        expected_categories = ['Camera', 'System', 'Media', 'PTZ', 'Configuration', 'Utility', 'Analysis', 'Security']
...
def test_tool_validation_function():
    ...
    try:
        ...
        assert not is_tool_class(BaseTool), "BaseTool itself should not be recognized as a tool class"
