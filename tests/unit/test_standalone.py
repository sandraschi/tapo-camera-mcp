...
async def test_server():
    ...
    with patch.dict('sys.modules', {'fastmcp': fastmcp_mock}):
        ...
        expected_tools = [
            "help", "connect_camera", "disconnect_camera", 
            "get_camera_info", "get_camera_status", "move_ptz",
            "get_stream_url", "set_motion_detection", "set_led_enabled",
            "set_privacy_mode", "reboot_camera", "get_ptz_presets"
        ]
        ...
        with patch('tapo_camera_mcp.server_v2.Tapo') as mock_tapo_class:
            ...
            mock_camera.getBasicInfo = AsyncMock(return_value={
            ...
            result = await server.mcp.call_tool("connect_camera", {
                "host": "192.168.1.100",
                "username": "testuser",
                "password": "testpass"
            })
